...
public class TestCase {
	...
	public TestCase(String test_name, String ontology, String data, String schema, String in_shape_map,
	...
	public String toString() {
		return "TestCase [test_name=" + test_name + ", ontology=" + ontology + ", data=" + data + ", schema=" + schema
